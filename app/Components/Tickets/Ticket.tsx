  ...
  return (
    <>
      {singleTicket && (
        ...
        <div id="ticket-content--date" className="flex flex-col justify-center items-center text-center  max-w-[150px] shrink font-title text-foreground">
          <h2>{day}</h2>
          <p className="font-bold text-2xl">{`${month} ${year}`}</p>
        </div>
        <div id="ticket-content--title" className="grow flex flex-col items-center justify-around text-shadow-white/80 text-shadow-xs">
