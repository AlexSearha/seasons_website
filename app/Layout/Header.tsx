          ...
          <div className="h-title mt-25 bg-[url(/pattern_old_paper.webp)] bg-clip-text text-transparent bg-cover">
            <div className="flex flex-col items-center w-3/5">
              ...
              <p className="bg-black/10 rounded-2xl p-8 text-lg md:text-2xl text-justify font-mono text-amber-100 mt-8">
                <span className="text-5xl">I</span>ci s&apos;élève la voix d&apos;un soldat. Un
                témoin de l&apos;Histoire qui, malgré le camp qu&apos;il avait choisi, a perçu les
                voix de celles et ceux qu&apos;on a voulu faire taire à coups de canons.
                <br />
                <br />
                ...
                braises de <span className="font-bold text-3xl">1871</span> : la sanglante année où
                Paris s&apos;est embrasée.
              </p>
              <Button href="/#ecouter" title="Ecouter l'histoire" classSup="mt-20" />
            </div>
          </div>
        </div>
      </div>
